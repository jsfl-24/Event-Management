...
export default function UserDetailsModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-zinc-800 rounded-xl shadow-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-zinc-700">
        {/* Header */}
        <div className="text-center mb-6">
          <h2 className="text-3xl font-bold text-white mb-2">
            Welcome to Take Down 2.0
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="pt-6 space-y-3">
              <button
                ...
                className="w-full bg-zinc-600 text-white py-3 px-4 rounded-md hover:bg-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-500 transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? "Saving..." : "Continue to Event"}
              </button>
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-zinc-500">
            Your information will be used for event registration and
